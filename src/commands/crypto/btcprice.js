...
module.exports = {
  data: new SlashCommandBuilder().setName("btcprice").setDescription("Live BTC price, 24h change, and market cap"),
  async execute(interaction) {
    const price = await fetchCryptoPrice("btc");
    await interaction.reply({ embeds: [economyEmbed({ title: "? Bitcoin Price", fields: [
